...
::: lead
A curated repository of spatial data sources, methods & applications for distributional analysis by [Geospatial Poverty Solutions](http://geopov/)
:::
...
tagList(
  ...
  create_dropdown_block("Infrastructure", prosperity, "#9b59b6", "https://cdn-icons-png.flaticon.com/512/10074/10074713.png"),
  create_dropdown_block("Digital", prosperity, "#f39c12", "https://cdn-icons-png.flaticon.com/512/10074/10074713.png"),
  create_dropdown_block("Boundaries", prosperity, "grey", "https://cdn-icons-png.flaticon.com/512/10074/10074713.png"),
  HTML('</div>')
)
```
...
Methods and reproducible code to help you use and analyze spatial data
...
tagList(
  ...
  create_dropdown_block("Merge", merge, "#f39c12", "https://cdn-icons-png.flaticon.com/512/9850/9850778.png"),
...
```{r echo=FALSE, results='asis'}
analyze <- data.frame(Name = c("A", "B", "C"), Source = c("A", "B", "C"))

tagList(
  HTML('<div class="blocks-container">'),
  create_dropdown_block("Analyze", analyze, "#e74c3c", "https://cdn-icons-png.flaticon.com/512/9850/9850778.png"),
  HTML('</div>')
)
```
