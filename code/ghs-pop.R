...
# Define parameters
  ...
  # population year
  pop_year <- 2025
    # 1970-2030 (five year intervals)

  # coordinate reference system
  crs <- 4326
    # 4326 = WGS84 or 54009 = Mollweide

  # spatial resolution
  res <- "30ss"
    # 4326/WGS84: 3ss = 3 arc seconds (~90 m) or 30ss = 30 arc seconds (~1 km)
    # 54009/Mollweide: 100 = 100 m or 1000 = 1 km
...
# This tells terra to stream the zip file from the URL and look for the tif file inside it
...
## get data for a specific area of interest from remote global file (not run)
